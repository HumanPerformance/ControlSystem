...
class MONITOR(QtCore.QThread):
    ...
    ready1 = QtCore.pyqtSignal(str)
    ready2 = QtCore.pyqtSignal(str)
    ready3 = QtCore.pyqtSignal(str)
    ready4 = QtCore.pyqtSignal(str)
    ready5 = QtCore.pyqtSignal(str)
    ready6 = QtCore.pyqtSignal(str)
    ready7 = QtCore.pyqtSignal(str)
    ready8 = QtCore.pyqtSignal(str)
    ready9 = QtCore.pyqtSignal(str)
    ready10 = QtCore.pyqtSignal(str)
    ...
    def run(self):
        while(True):
            if self.updatepanel["p1"]:
                ...
                elif (PANEL_STATUS[0][0] == "NULL" and PANEL_STATUS[0][1] == "AOK"):
                    pass
                elif (PANEL_STATUS[0][0] == "RDY1" and PANEL_STATUS[0][1] == "RDY1"):
                    self.ready1.emit("INT1")
                elif (PANEL_STATUS[0][0] == "RDY2" and PANEL_STATUS[0][1] == "RDY2"):
                    self.ready1.emit("INT2")
                else:
...
class GUI(object):
    ...
    def __init__(self, MainWindow):
        ...
        self.INT1All = QtWidgets.QPushButton(MainWindow)
        self.INT1All.setMaximumSize(QtCore.QSize(16777215, 50))
        self.INT1All.setFont(initBtnfont)
        self.INT1All.setObjectName("INT1All")
        self.gridAll.addWidget(self.INT1All)

        self.INT2All = QtWidgets.QPushButton(MainWindow)
        self.INT2All.setMaximumSize(QtCore.QSize(16777215, 50))
        self.INT2All.setFont(initBtnfont)
        self.INT2All.setObjectName("INT2All")
        self.gridAll.addWidget(self.INT2All)
        ...
        self.p1INT1 = QtWidgets.QPushButton(MainWindow)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHeightForWidth(self.p1INT1.sizePolicy().hasHeightForWidth())
        self.p1INT1.setSizePolicy(sizePolicy)
        self.p1INT1.setMinimumSize(QtCore.QSize(25, 50))
        self.p1INT1.setObjectName("p1INT1")
        self.p1INT1.setFont(initBtnfont)
        self.p1INT1.setEnabled(False)
        self.gridP1.addWidget(self.p1INT1, 3, 1, 1, 1)

        self.p1INT2 = QtWidgets.QPushButton(MainWindow)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHeightForWidth(self.p1INT2.sizePolicy().hasHeightForWidth())
        self.p1INT2.setSizePolicy(sizePolicy)
        self.p1INT2.setMinimumSize(QtCore.QSize(25, 50))
        self.p1INT2.setObjectName("p1INT2")
        self.p1INT2.setFont(initBtnfont)
        self.p1INT2.setEnabled(False)
        self.gridP1.addWidget(self.p1INT2, 3, 0, 1, 1)
        ...
        self.p2INT1 = QtWidgets.QPushButton(MainWindow)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHeightForWidth(self.p2INT1.sizePolicy().hasHeightForWidth())
        self.p2INT1.setSizePolicy(sizePolicy)
        self.p2INT1.setMinimumSize(QtCore.QSize(25, 50))
        self.p2INT1.setObjectName("p2INT1")
        self.p2INT1.setFont(initBtnfont)
        self.p2INT1.setEnabled(False)
        self.gridP2.addWidget(self.p2INT1, 3, 1, 1, 1)

        self.p2INT2 = QtWidgets.QPushButton(MainWindow)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHeightForWidth(self.p2INT2.sizePolicy().hasHeightForWidth())
        self.p2INT2.setSizePolicy(sizePolicy)
        self.p2INT2.setMinimumSize(QtCore.QSize(25, 50))
        self.p2INT2.setObjectName("p2INT2")
        self.p2INT2.setFont(initBtnfont)
        self.p2INT2.setEnabled(False)
        self.gridP2.addWidget(self.p2INT2, 3, 0, 1, 1)
        ...
        self.p3INT1 = QtWidgets.QPushButton(MainWindow)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHeightForWidth(self.p3INT1.sizePolicy().hasHeightForWidth())
        self.p3INT1.setSizePolicy(sizePolicy)
        self.p3INT1.setMinimumSize(QtCore.QSize(25, 50))
        self.p3INT1.setObjectName("p3INT1")
        self.p3INT1.setFont(initBtnfont)
        self.p3INT1.setEnabled(False)
        self.gridP3.addWidget(self.p3INT1, 3, 1, 1, 1)

        self.p3INT2 = QtWidgets.QPushButton(MainWindow)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHeightForWidth(self.p3INT2.sizePolicy().hasHeightForWidth())
        self.p3INT2.setSizePolicy(sizePolicy)
        self.p3INT2.setMinimumSize(QtCore.QSize(25, 50))
        self.p3INT2.setObjectName("p3INT2")
        self.p3INT2.setFont(initBtnfont)
        self.p3INT2.setEnabled(False)
        self.gridP3.addWidget(self.p3INT2, 3, 0, 1, 1)
        ...
        self.p4INT1 = QtWidgets.QPushButton(MainWindow)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHeightForWidth(self.p4INT1.sizePolicy().hasHeightForWidth())
        self.p4INT1.setSizePolicy(sizePolicy)
        self.p4INT1.setMinimumSize(QtCore.QSize(25, 50))
        self.p4INT1.setObjectName("p4INT1")
        self.p4INT1.setFont(initBtnfont)
        self.p4INT1.setEnabled(False)
        self.gridP4.addWidget(self.p4INT1, 4, 1, 1, 1)

        self.p4INT2 = QtWidgets.QPushButton(MainWindow)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHeightForWidth(self.p4INT2.sizePolicy().hasHeightForWidth())
        self.p4INT2.setSizePolicy(sizePolicy)
        self.p4INT2.setMinimumSize(QtCore.QSize(25, 50))
        self.p4INT2.setObjectName("p4INT2")
        self.p4INT2.setFont(initBtnfont)
        self.p4INT2.setEnabled(False)
        self.gridP4.addWidget(self.p4INT2, 4, 0, 1, 1)
        ...
        self.p5INT1 = QtWidgets.QPushButton(MainWindow)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHeightForWidth(self.p5INT1.sizePolicy().hasHeightForWidth())
        self.p5INT1.setSizePolicy(sizePolicy)
        self.p5INT1.setMinimumSize(QtCore.QSize(25, 50))
        self.p5INT1.setObjectName("p5INT1")
        self.p5INT1.setFont(initBtnfont)
        self.p5INT1.setEnabled(False)
        self.gridP5.addWidget(self.p5INT1, 4, 1, 1, 1)

        self.p5INT2 = QtWidgets.QPushButton(MainWindow)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHeightForWidth(self.p5INT2.sizePolicy().hasHeightForWidth())
        self.p5INT2.setSizePolicy(sizePolicy)
        self.p5INT2.setMinimumSize(QtCore.QSize(25, 50))
        self.p5INT2.setObjectName("p5INT2")
        self.p5INT2.setFont(initBtnfont)
        self.p5INT2.setEnabled(False)
        self.gridP5.addWidget(self.p5INT2, 4, 0, 1, 1)
        ...
        self.p6INT1 = QtWidgets.QPushButton(MainWindow)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHeightForWidth(self.p6INT1.sizePolicy().hasHeightForWidth())
        self.p6INT1.setSizePolicy(sizePolicy)
        self.p6INT1.setMinimumSize(QtCore.QSize(25, 50))
        self.p6INT1.setObjectName("p6INT1")
        self.p6INT1.setFont(initBtnfont)
        self.p6INT1.setEnabled(False)
        self.gridP6.addWidget(self.p6INT1, 3, 1, 1, 1)

        self.p6INT2 = QtWidgets.QPushButton(MainWindow)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHeightForWidth(self.p6INT2.sizePolicy().hasHeightForWidth())
        self.p6INT2.setSizePolicy(sizePolicy)
        self.p6INT2.setMinimumSize(QtCore.QSize(25, 50))
        self.p6INT2.setObjectName("p6INT2")
        self.p6INT2.setFont(initBtnfont)
        self.p6INT2.setEnabled(False)
        self.gridP6.addWidget(self.p6INT2, 3, 0, 1, 1)
        ...
        self.p7INT1 = QtWidgets.QPushButton(MainWindow)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHeightForWidth(self.p7INT1.sizePolicy().hasHeightForWidth())
        self.p7INT1.setSizePolicy(sizePolicy)
        self.p7INT1.setMinimumSize(QtCore.QSize(25, 50))
        self.p7INT1.setObjectName("p7INT1")
        self.p7INT1.setFont(initBtnfont)
        self.p7INT1.setEnabled(False)
        self.gridP7.addWidget(self.p7INT1, 3, 1, 1, 1)

        self.p7INT2 = QtWidgets.QPushButton(MainWindow)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHeightForWidth(self.p7INT2.sizePolicy().hasHeightForWidth())
        self.p7INT2.setSizePolicy(sizePolicy)
        self.p7INT2.setMinimumSize(QtCore.QSize(25, 50))
        self.p7INT2.setObjectName("p7INT2")
        self.p7INT2.setFont(initBtnfont)
        self.p7INT2.setEnabled(False)
        self.gridP7.addWidget(self.p7INT2, 3, 0, 1, 1)
        ...
        self.p8INT1 = QtWidgets.QPushButton(MainWindow)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHeightForWidth(self.p8INT1.sizePolicy().hasHeightForWidth())
        self.p8INT1.setSizePolicy(sizePolicy)
        self.p8INT1.setMinimumSize(QtCore.QSize(25, 50))
        self.p8INT1.setObjectName("p8INT1")
        self.p8INT1.setFont(initBtnfont)
        self.p8INT1.setEnabled(False)
        self.gridP8.addWidget(self.p8INT1, 3, 1, 1, 1)

        self.p8INT2 = QtWidgets.QPushButton(MainWindow)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHeightForWidth(self.p8INT2.sizePolicy().hasHeightForWidth())
        self.p8INT2.setSizePolicy(sizePolicy)
        self.p8INT2.setMinimumSize(QtCore.QSize(25, 50))
        self.p8INT2.setObjectName("p8INT2")
        self.p8INT2.setFont(initBtnfont)
        self.p8INT2.setEnabled(False)
        self.gridP8.addWidget(self.p8INT2, 3, 0, 1, 1)
        ...
        self.p9INT1 = QtWidgets.QPushButton(MainWindow)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.p9INT1.sizePolicy().hasHeightForWidth())
        self.p9INT1.setSizePolicy(sizePolicy)
        self.p9INT1.setMinimumSize(QtCore.QSize(25, 50))
        self.p9INT1.setObjectName("p9INT1")
        self.p9INT1.setFont(initBtnfont)
        self.p9INT1.setEnabled(False)
        self.gridP9.addWidget(self.p9INT1, 3, 1, 1, 1)

        self.p9INT2 = QtWidgets.QPushButton(MainWindow)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHeightForWidth(self.p9INT2.sizePolicy().hasHeightForWidth())
        self.p9INT2.setSizePolicy(sizePolicy)
        self.p9INT2.setMinimumSize(QtCore.QSize(25, 50))
        self.p9INT2.setObjectName("p9INT2")
        self.p9INT2.setFont(initBtnfont)
        self.p9INT2.setEnabled(False)
        self.gridP9.addWidget(self.p9INT2, 3, 0, 1, 1)
        ...
        self.p10INT1 = QtWidgets.QPushButton(MainWindow)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHeightForWidth(self.p10INT1.sizePolicy().hasHeightForWidth())
        self.p10INT1.setSizePolicy(sizePolicy)
        self.p10INT1.setMinimumSize(QtCore.QSize(25, 50))
        self.p10INT1.setObjectName("p10INT1")
        self.p10INT1.setFont(initBtnfont)
        self.p10INT1.setEnabled(False)
        self.gridP10.addWidget(self.p10INT1, 3, 1, 1, 1)

        self.p10INT2 = QtWidgets.QPushButton(MainWindow)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHeightForWidth(self.p10INT2.sizePolicy().hasHeightForWidth())
        self.p10INT2.setSizePolicy(sizePolicy)
        self.p10INT2.setMinimumSize(QtCore.QSize(25, 50))
        self.p10INT2.setObjectName("p10INT2")
        self.p10INT2.setFont(initBtnfont)
        self.p10INT2.setEnabled(False)
        self.gridP10.addWidget(self.p10INT2, 3, 0, 1, 1)
        ...
        self.p1INT1.clicked.connect(lambda: self.p1INT(1))
        self.p1INT2.clicked.connect(lambda: self.p1INT(2))
        self.p2INT1.clicked.connect(lambda: self.p2INT(1))
        self.p2INT2.clicked.connect(lambda: self.p2INT(2))
        self.p3INT1.clicked.connect(lambda: self.p3INT(1))
        self.p3INT2.clicked.connect(lambda: self.p3INT(2))
        self.p4INT1.clicked.connect(lambda: self.p4INT(1))
        self.p4INT2.clicked.connect(lambda: self.p4INT(2))
        self.p5INT1.clicked.connect(lambda: self.p5INT(1))
        self.p5INT2.clicked.connect(lambda: self.p5INT(2))
        self.p6INT1.clicked.connect(lambda: self.p6INT(1))
        self.p6INT2.clicked.connect(lambda: self.p6INT(2))
        self.p7INT1.clicked.connect(lambda: self.p7INT(1))
        self.p7INT2.clicked.connect(lambda: self.p7INT(2))
        self.p8INT1.clicked.connect(lambda: self.p8INT(1))
        self.p8INT2.clicked.connect(lambda: self.p8INT(2))
        self.p9INT1.clicked.connect(lambda: self.p9INT(1))
        self.p9INT2.clicked.connect(lambda: self.p9INT(2))
        self.p10INT1.clicked.connect(lambda: self.p10INT(1))
        self.p10INT2.clicked.connect(lambda: self.p10INT(2))

        # self.connectAll.clicked.connect()
        # self.INT1All.clicked.connect()
        # self.INT2All.clicked.connect()
        # self.fetchAll.clicked.connect()
    ...
    def iniTranslate(self, MainWindow):
        ...
        self.p1INT1.setText(_translate("MainWindow", "INT: 1"))
        self.p1INT2.setText(_translate("MainWindow", "INT: 2"))

        self.p2.setText(_translate("MainWindow", "Panel 2"))
        self.p2connect.setText(_translate("MainWindow", "Connect"))
        self.p2INT1.setText(_translate("MainWindow", "INT: 1"))
        self.p2INT2.setText(_translate("MainWindow", "INT: 2"))

        self.p3.setText(_translate("MainWindow", "Panel 3"))
        self.p3connect.setText(_translate("MainWindow", "Connect"))
        self.p3INT1.setText(_translate("MainWindow", "INT: 1"))
        self.p3INT2.setText(_translate("MainWindow", "INT: 2"))

        self.p4.setText(_translate("MainWindow", "Panel 4"))
        self.p4INT1.setText(_translate("MainWindow", "INT: 1"))
        self.p4INT2.setText(_translate("MainWindow", "INT: 2"))
        ...
        self.p5INT1.setText(_translate("MainWindow", "INT: 1"))
        self.p5INT2.setText(_translate("MainWindow", "INT: 2"))

        self.p6.setText(_translate("MainWindow", "Panel 6"))
        self.p6connect.setText(_translate("MainWindow", "Connect"))
        self.p6INT1.setText(_translate("MainWindow", "INT: 1"))
        self.p6INT2.setText(_translate("MainWindow", "INT: 2"))

        self.p7.setText(_translate("MainWindow", "Panel 7"))
        self.p7connect.setText(_translate("MainWindow", "Connect"))
        self.p7INT1.setText(_translate("MainWindow", "INT: 1"))
        self.p7INT2.setText(_translate("MainWindow", "INT: 2"))

        self.p8.setText(_translate("MainWindow", "Panel 8"))
        self.p8connect.setText(_translate("MainWindow", "Connect"))
        self.p8INT1.setText(_translate("MainWindow", "INT: 1"))
        self.p8INT2.setText(_translate("MainWindow", "INT: 2"))

        self.p9.setText(_translate("MainWindow", "Panel 9"))
        self.p9connect.setText(_translate("MainWindow", "Connect"))
        self.p9INT1.setText(_translate("MainWindow", "INT: 1"))
        self.p9INT2.setText(_translate("MainWindow", "INT: 2"))

        self.p10.setText(_translate("MainWindow", "Panel 10"))
        self.p10connect.setText(_translate("MainWindow", "Connect"))
        self.p10INT1.setText(_translate("MainWindow", "INT: 1"))
        self.p10INT2.setText(_translate("MainWindow", "INT: 2"))

        self.connectAll.setText(_translate("MainWindow", "Connect All"))
        self.INT1All.setText(_translate("MainWindow", "Interaction: 1"))
        self.INT2All.setText(_translate("MainWindow", "Interaction: 2"))
    ...
    def p1INT(self, whichINT):
        if(whichINT == 1):
            print("P1INT1")
            self.activateP1int1_consys = TUNNEL()
            self.activateP1int1_consys.direct(PANEL_COMMAND["p1i1consys"], PANEL_IP["pi1"])
            self.activateP1int1_consys.output.connect(self.updatestatus_consys1)
            self.activateP1int1_consys.start()

            self.activateP1int1_bpc = TUNNEL()
            self.activateP1int1_bpc.direct(PANEL_COMMAND["p1i1bpc"], PANEL_IP["pi2"])
            self.activateP1int1_bpc.output.connect(self.updatestatus_bpc1)
            self.activateP1int1_bpc.start()

            self.p1connect.setText(_translate("MainWindow", "Running"))
            self.p1INT1.setEnabled(False)
            self.p1INT2.setEnabled(False)

        else:
            print("P1INT2")
            self.activateP1int2_consys = TUNNEL()
            self.activateP1int2_consys.direct(PANEL_COMMAND["test"], PANEL_IP["pi1"])
            self.activateP1int2_consys.start()

            self.activateP1int2_bpc = TUNNEL()
            self.activateP1int2_bpc.direct(PANEL_COMMAND["test"], PANEL_IP["pi2"])
            self.activateP1int2_bpc.start()
    ...
    def connected1(self, bool):
        ...
        if bool:
            ...
            self.p1INT1.setEnabled(True)
            self.p1INT2.setEnabled(True)
        else:
...
"normconsys": "python pd3d/csec/repos/ControlSystem/Software/Python/consys/consys4.3.py",
