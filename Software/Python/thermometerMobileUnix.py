...
from bluetoothProtocol import createPort
...
# Find Thermometer
def connect2Thermometer(deviceName,deviceBTAddress,baudrate,timeout):
    print fullStamp() + " findThermometer()"
    global rfObject
    rfObject = createPort(deviceName,deviceBTAddress,baudrate,timeout)
    rfObject.close()
...
searchDevicesButton = Button(text="Find Thermometer",
                             command=lambda: connect2Thermometer("SmartThermometer-7701","00:06:66:86:77:01", 115200, 5))   #Lab Computer
                             #command=lambda: connect2Thermometer("RNBT-7712","00:06:66:86:77:12", 115200, 5))   #Lab Computer
                             #command=lambda: connect2Thermometer("RNBT-76C5","00:06:66:86:76:C5", 115200, 5))   #Jack's Laptop
